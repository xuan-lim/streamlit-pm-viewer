# --- Start of Main App Logic ---
   if 'df' in st.session_state:
       ...
       if selected_tab == "Dashboard Overview":
           ...
           with col2: # This is the end of the 'with' statement for col2
               # st.header("🔔 Alerts")
               # ... (all alert logic) ...
       ...
       # --- THIS IS THE CRITICAL FIX: Ensure this 'elif' is aligned with its parent 'if' ---
       elif selected_tab == "Full Data Table": # This line was causing the IndentationError
